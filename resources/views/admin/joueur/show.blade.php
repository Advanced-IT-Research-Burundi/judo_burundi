    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-2">
                        <div class="avatar-xl bg-primary rounded-circle d-flex align-items-center justify-content-center text-white mx-auto">
        ...
        {{-- Section pour les compétitions/matchs si applicable --}}
        {{-- 
        @if(isset($joueur->matches) && $joueur->matches->count() > 0)
        <div class="card mt-4">
            <div class="card-header">
                <h5 class="card-title mb-0">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    @php
                        ...
                        if($joueur->nom) $completed_fields++;
                        if($joueur->prenom) $completed_fields++;
                        if($joueur->date_naissance) $completed_fields++;
                        if($joueur->lieu_naissance) $completed_fields++;
                        if($joueur->sexe) $completed_fields++;
                        if($joueur->telephone) $completed_fields++;
                        if($joueur->email) $completed_fields++;
                        if($joueur->categorie_id) $completed_fields++;
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    @if($joueur->telephone)
                        <a href="tel:{{ $joueur->telephone }}" class="btn btn-success">
                    ...
                    @if($joueur->email)
                        <a href="mailto:{{ $joueur->email }}" class="btn btn-info">
