        ...
        <div class="contact-content">
            ...
            <form class="contact-form" method="POST" action="{{ route('contact.submit') }}" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nom" name="name" value="{{ old('name') }}"
                        class="@error('name') error-input @enderror" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}"
                        class="@error('email') error-input @enderror" required>
                    @error('email')
                        <small class="error-message">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="sujet" name="sujet" value="{{ old('sujet') }}"
                        class="@error('sujet') error-input @enderror" required>
                    @error('sujet')
                        <small class="error-message">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="message" name="message" rows="5" class="@error('message') error-input @enderror" required>{{ old('message') }}</textarea>
                    @error('message')
                        <small class="error-message">{{ $message }}</small>
                    @enderror
                </div>
