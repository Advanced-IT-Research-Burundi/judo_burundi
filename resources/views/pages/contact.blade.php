            ...
            <div class="contact-form-wrapper">
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="contact-form">
                    ...
                    <div class="form-group">
                        ...
                        <select id="sujet" 
                                name="sujet" 
                                class="@error('sujet') error @enderror"
                                required>
                            <option value="">Choisissez un sujet</option>
                            <option value="Inscription" {{ old('sujet') == 'Inscription' ? 'selected' : '' }}>Inscription</option>
                            <option value="Information générale" {{ old('sujet') == 'Information générale' ? 'selected' : '' }}>Information générale</option>
                            <option value="Cours et formations" {{ old('sujet') == 'Cours et formations' ? 'selected' : '' }}>Cours et formations</option>
                            <option value="Compétitions" {{ old('sujet') == 'Compétitions' ? 'selected' : '' }}>Compétitions</option>
...
.social-link.instagram { background: rgba(228, 64, 95, 0.8); }
